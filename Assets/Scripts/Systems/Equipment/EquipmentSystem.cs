...
namespace Xiuxian.Systems
{
    ...
    public static class EquipmentSystem
    {
        ...
        {
            new QualityTier { Quality = "mortal", DisplayName = "凡品", Rarity = "common", StatMultiplier = 1.0, PrefixSlots = 0, SuffixSlots = 0, PriceMultiplier = 1.0, DropWeight = 50, LuckScaling = 0 },
            new QualityTier { Quality = "spirit", DisplayName = "灵器", Rarity = "uncommon", StatMultiplier = 1.5, PrefixSlots = 1, SuffixSlots = 0, PriceMultiplier = 2.0, DropWeight = 30, LuckScaling = 0.005 },
            new QualityTier { Quality = "treasure", DisplayName = "法宝", Rarity = "rare", StatMultiplier = 2.5, PrefixSlots = 1, SuffixSlots = 1, PriceMultiplier = 5.0, DropWeight = 12, LuckScaling = 0.01 },
            new QualityTier { Quality = "immortal", DisplayName = "仙器", Rarity = "epic", StatMultiplier = 4.0, PrefixSlots = 2, SuffixSlots = 1, PriceMultiplier = 12.0, DropWeight = 6, LuckScaling = 0.015 },
            new QualityTier { Quality = "ancient", DisplayName = "太古", Rarity = "legendary", StatMultiplier = 6.0, PrefixSlots = 2, SuffixSlots = 2, PriceMultiplier = 25.0, DropWeight = 2, LuckScaling = 0.02 },
        };
